...
class TestCourses:
    ...
    def test_edit_course(self, courses_list_page: CoursesListPage, create_course_page: CreateCoursePage):
        ...
        create_course_page.create_course_toolbar_view.click_create_course_button()
        create_course_page.check_current_url("https://nikita-filonov.github.io/qa-automation-engineer-ui-course/#/courses")
        courses_list_page.course_view.check_visible(
            index=0, title="Hello, world!", max_score="1000", min_score="100", estimated_time="3 weeks"
        )

        # Редактируем карточку курса
        ...
        # Проверяем изменение карточки курса
        courses_list_page.toolbar_view.check_visible()
        courses_list_page.course_view.check_visible(
            index=0, title="Playwright", max_score="100", min_score="10", estimated_time="2 weeks"
        )
