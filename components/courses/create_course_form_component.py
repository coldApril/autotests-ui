...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page):
        ...
        self.create_course_title_input = Input(page, 'create-course-form-title-input', "New Course")
        self.create_course_estimated_time_input = Input(page, 'create-course-form-estimated-time-input', "Estimated time")
        self.create_course_description_textarea = Textarea(page, 'create-course-form-description-input', "Course description")
